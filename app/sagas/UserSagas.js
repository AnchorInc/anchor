...
function* updateUserSaga(action) {
  ...
  try {
    ...
    const g = yield call([w, w.where], 'studentId', '==', firebase.auth().currentUser.uid);
    ...
    chatRefArray.forEach((reference) => {
      ...
      console.log(chatRef);
      batch.update(chatRef, { studentName: action.user.displayName });
    });
  } catch (error) {
    console.log(error);
  }
